...
def main(m, n):
    ...
    if n == 8:
        ...
        print(
            f"\nНормоване рівняння регресії: y = {b_i[0]:.5f} + {b_i[1]:.5f} * x1 + {b_i[2]:.5f} * x2 + "
    ...
    if n == 4:
        ...
        b_i = [i / det for i in det_i]
        print(
            f"\nНормоване рівняння регресії: y = {b_i[0]:.5f} + {b_i[1]:.5f} * x1 + {b_i[2]:.5f} * x2 + {b_i[3]:.5f} * x3\n")
    ...
    if g_p < g_t:
        print(f"Варіантність однорідна: Gp = {g_p:.5} < Gt = {g_t}")
    else:
        print(f"Варіантність не однорідна Gp = {g_p:.5} < Gt = {g_t}\nStart again with m = m + 1")
    ...
    if n == 8:
        print(
            f"Рівняння регресії: y = {beta_i[0]:.5f} + {beta_i[1]:.5f} * x1 + {beta_i[2]:.5f} * x2 + "
        ...
        print("Нормовані значення: ", check_i)
    ...
    if f_p > f_t[f_3][f_4]:
        print(
            f"fp = {f_p} > ft = {f_t[f_3][f_4]}.\nМатематична модель не є адекватною для експериментальних даних "
            f"\n\nПочнемо знову з m = m + 1")
        main(m=m + 1, n=8)
    else:
        print(f"fP = {f_p} < fT = {f_t[f_3][f_4]}.\nМатематична модель є адекватною для експериментальних даних")
